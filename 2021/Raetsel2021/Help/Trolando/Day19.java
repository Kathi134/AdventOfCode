//all rights to "trolando" / Tom van Dijk on github

package Raetsel2021.Help.Trolando;
...
public class Day19 extends Day 
{
    ...
    public static class ScannerOrientation {
    ...
    protected void part1(String fileContents) {
        ScannerOrientation[] scanners = orientations(parse(fileContents)).toArray(ScannerOrientation[]::new);
